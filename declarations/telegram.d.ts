// Этот файл 1 в 1 взят из ссылки ниже и необходим для типизации window в соответствии с TelegramAPI
// https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/telegram-web-app/index.d.ts
...
export interface WebApp {
	...
	onEvent(
		...
		eventHandler: SafeAreaChangedChangedCallback,
	): void;
	onEvent(
		eventType: "contentSafeAreaChanged",
		eventHandler: ContentSafeAreaChangedCallback,
	): void;
	onEvent(
	...
	onEvent(
		...
		eventHandler: FullscreenFailedCallback,
	): void;
	onEvent(
		eventType: "homeScreenAdded",
		eventHandler: HomeScreenAddedCallback,
	): void;
	onEvent(
		eventType: "homeScreenChecked",
		eventHandler: HomeScreenCheckedCallback,
	): void;
	onEvent(
		eventType: "accelerometerStarted",
		eventHandler: AccelerometerStartedCallback,
	): void;
	onEvent(
		eventType: "accelerometerStopped",
		eventHandler: AccelerometerStoppedCallback,
	): void;
	onEvent(
		eventType: "accelerometerChanged",
		eventHandler: AccelerometerChangedCallback,
	): void;
	onEvent(
		eventType: "accelerometerFailed",
		eventHandler: AccelerometerFailedCallback,
	): void;
	onEvent(
		eventType: "deviceOrientationStarted",
		eventHandler: DeviceOrientationStartedCallback,
	): void;
	onEvent(
		eventType: "deviceOrientationStopped",
		eventHandler: DeviceOrientationStoppedCallback,
	): void;
	onEvent(
	...
	onEvent(
		...
		eventHandler: DeviceOrientationFailedCallback,
	): void;
	onEvent(
		eventType: "gyroscopeStarted",
		eventHandler: GyroscopeStartedCallback,
	): void;
	onEvent(
		eventType: "gyroscopeStopped",
		eventHandler: GyroscopeStoppedCallback,
	): void;
	onEvent(
		eventType: "gyroscopeChanged",
		eventHandler: GyroscopeChangedCallback,
	): void;
	onEvent(
		eventType: "gyroscopeFailed",
		eventHandler: GyroscopeFailedCallback,
	): void;
	onEvent(
		eventType: "locationManagerUpdated",
		eventHandler: LocationManagerUpdatedCallback,
	): void;
	onEvent(
		eventType: "locationRequested",
		eventHandler: LocationRequestedCallback,
	): void;
	onEvent(
		eventType: "shareMessageSent",
		eventHandler: ShareMessageSentCallback,
	): void;
	onEvent(
		eventType: "shareMessageFailed",
		eventHandler: ShareMessageFailedCallback,
	): void;
	onEvent(
		eventType: "emojiStatusSet",
		eventHandler: EmojiStatusSetCallback,
	): void;
	onEvent(
		eventType: "emojiStatusFailed",
		eventHandler: EmojiStatusFailedCallback,
	): void;
	onEvent(
		eventType: "emojiStatusAccessRequested",
		eventHandler: EmojiStatusAccessRequestedCallback,
	): void;
	onEvent(
		eventType: "fileDownloadRequested",
		eventHandler: FileDownloadRequestedCallback,
	): void;
...
export type ContactRequestedCallback = (
	eventData: RequestContactResponse,
) => void;
...
export type CloudStorageSetItemCallback = (
	error: string | null,
	success: null | true,
) => void;
export type CloudStorageGetItemCallback = (
	error: string | null,
	value: null | string,
) => void;
export type CloudStorageGetItemsCallback = (
	error: string | null,
	values: null | Record<string, string>,
) => void;
export type CloudStorageRemoveItemCallback = (
	error: string | null,
	success: null | true,
) => void;
export type CloudStorageRemoveItemsCallback = (
	error: string | null,
	success: null | true,
) => void;
export type CloudStorageGetKeysCallback = (
	error: string | null,
	keys: null | string[],
) => void;
...
export type BiometricAuthenticateCallback = (
	isAuthenticated: boolean,
	biometricToken?: string,
) => void;
...
export interface DeviceStorage {
	...
	getItem: (
		key: string,
		callback?: (error: string | null, item: string) => void,
	) => DeviceStorage;
	/**
	 * Bot API 9.0+
	 *
